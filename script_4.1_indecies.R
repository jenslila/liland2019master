...
#   D <- as.numeric(x[3])
  ...
  cmd <- paste("Rscript script_RandomFastaLinesIndecies.R",
               paste(rfiles, collapse=" "))
  out <- system(cmd, intern=TRUE)
}
# }}}
out <- parallel::parApply(cl=cl, X=X, MARGIN=1, FUN=fetch.indecies)
out
